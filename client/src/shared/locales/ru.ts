export const ru = {
    ...
    auth: {
        ...
        toLogin: 'вход',
        passwordWeak:
            'Пароль должен быть не менее 8 и не больше 32 символов и содержать заглавные, строчные буквы, цифры и специальные символы.',
        passwordTooShort:
    ...
    stats: {
        ...
        notCounted: {
            ...
            lowAccuracy: 'из-за слишком низкой точности (меньше 50%)',
            tooManyTextErrors:
                'из-за большого количества ошибок в тексте (больше 20)',
        },
        leaderboardDisqualified: {
            base: 'Результат не будет учитываться в таблице лидеров',
            lowAccuracy: 'из-за низкой точности (меньше 90%)',
            tooManyCorrections:
                'из-за большого количества исправлений (больше 20)',
        },
        metrics: {
            accuracy: 'Точность',
            cpm: 'СВМ',
